...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>被评商品</td><td>评论内容</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="productCommentDelete('<%=productComment.getCommentId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productCommentQueryForm" id="productCommentQueryForm" action="<%=basePath %>ProductComment/userFrontlist" class="mar_t15" method="post">
