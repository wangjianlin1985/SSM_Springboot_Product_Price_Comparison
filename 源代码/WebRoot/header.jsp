...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">比价网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>ProductComment/frontlist">商品评论</a></li> -->
                <li><a href="<%=basePath %>ProductClass/frontlist">商品类别</a></li>
                <li><a href="<%=basePath %>Product/frontlist">商品查询</a></li>
                <li><a href="<%=basePath %>SellerPrice/frontlist">商家价格</a></li>
                <li><a href="<%=basePath %>Seller/frontlist">商家查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>ProductComment/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我发布的评论</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我发布的留言</a></li>
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontSelfModify.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
