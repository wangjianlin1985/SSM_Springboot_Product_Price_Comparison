...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">市场价格:</div>
	...
	<div class="row bottom15">
		...
		<div class="col-md-6 col-xs-6">
			...
			<button onclick="javascript:location.href='<%=basePath %>SellerPrice/frontlist?productObj.productId=<%=product.getProductId() %>';" class="btn btn-primary">商家报价对比</button>
