		       ...
		       text: "商品评论管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ProductComment/productComment_add.jsp"
			    	   	},
			    		{
			    	   		text: "商品评论管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ProductComment/productComment_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "商家报价管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SellerPrice/sellerPrice_add.jsp"
			    	   	},
			    		{
			    	   		text: "商家价格管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SellerPrice/sellerPrice_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "商家管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Seller/seller_add.jsp"
			    	   	},
			    		{
			    	   		text: "商家管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Seller/seller_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
